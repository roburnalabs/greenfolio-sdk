...
var FACTORY_ADDRESS_ETHEREUM = '0xff68DFd7230a098C10D02c043B6eb8A6400aE64F';
var FACTORY_ADDRESS_ETHEREUM_EXTERNAL = '0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f';
...
var FACTORY_ADDRESS_BSC_TESTNET_EXTERNAL = '0x6725F303b657a9451d8BA641348b6761A6CC7a17';
var FACTORY_ADDRESS_MAP = (_FACTORY_ADDRESS_MAP = {}, _FACTORY_ADDRESS_MAP[ChainId.ETHEREUM] = FACTORY_ADDRESS_ETHEREUM, _FACTORY_ADDRESS_MAP[ChainId.BSC] = FACTORY_ADDRESS, _FACTORY_ADDRESS_MAP[ChainId.BSC_TESTNET] = FACTORY_ADDRESS, _FACTORY_ADDRESS_MAP[ChainId.ROBURNA] = FACTORY_ADDRESS_ROBURNA, _FACTORY_ADDRESS_MAP[ChainId.ROBURNA_TESTNET] = FACTORY_ADDRESS_ROBURNA_TESTNET, _FACTORY_ADDRESS_MAP);
var EXTERNAL_FACTORY_ADDRESS_MAP = (_EXTERNAL_FACTORY_ADD = {}, _EXTERNAL_FACTORY_ADD[ChainId.ETHEREUM] = FACTORY_ADDRESS_ETHEREUM_EXTERNAL, _EXTERNAL_FACTORY_ADD[ChainId.BSC] = FACTORY_ADDRESS_EXTERNAL, _EXTERNAL_FACTORY_ADD[ChainId.BSC_TESTNET] = FACTORY_ADDRESS_BSC_TESTNET_EXTERNAL, _EXTERNAL_FACTORY_ADD[ChainId.ROBURNA] = FACTORY_ADDRESS_EXTERNAL, _EXTERNAL_FACTORY_ADD[ChainId.ROBURNA_TESTNET] = FACTORY_ADDRESS_EXTERNAL, _EXTERNAL_FACTORY_ADD);
var INIT_CODE_HASH = '0x2e26c6a371cb994ce7b30f334480a5782dff687140d5608ced830fc138a0ed7b';
var INIT_CODE_HASH_ETHEREUM = '0x568d807ff31b5c3ec99125e4aeff3b02ee98c66ff603152daee8b2e7d279b83b';
var INIT_CODE_HASH_ETHEREUM_EXTERNAL = '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f';
...
var INIT_CODE_HASH_MAP = (_INIT_CODE_HASH_MAP = {}, _INIT_CODE_HASH_MAP[ChainId.ETHEREUM] = INIT_CODE_HASH_ETHEREUM, _INIT_CODE_HASH_MAP[ChainId.BSC] = INIT_CODE_HASH, _INIT_CODE_HASH_MAP[ChainId.BSC_TESTNET] = INIT_CODE_HASH, _INIT_CODE_HASH_MAP[ChainId.ROBURNA] = INIT_CODE_HASH_ROBURNA, _INIT_CODE_HASH_MAP[ChainId.ROBURNA_TESTNET] = INIT_CODE_HASH_ROBURNA, _INIT_CODE_HASH_MAP);
var EXTERNAL_CODE_HASH_MAP = (_EXTERNAL_CODE_HASH_M = {}, _EXTERNAL_CODE_HASH_M[ChainId.ETHEREUM] = INIT_CODE_HASH_ETHEREUM_EXTERNAL, _EXTERNAL_CODE_HASH_M[ChainId.BSC] = INIT_CODE_HASH_EXTERNAL, _EXTERNAL_CODE_HASH_M[ChainId.BSC_TESTNET] = INIT_CODE_HASH_BSC_TESTNET, _EXTERNAL_CODE_HASH_M[ChainId.ROBURNA] = INIT_CODE_HASH_EXTERNAL, _EXTERNAL_CODE_HASH_M[ChainId.ROBURNA_TESTNET] = INIT_CODE_HASH_BSC_TESTNET, _EXTERNAL_CODE_HASH_M);
...
Currency.NATIVE = (_Currency$NATIVE = {}, _Currency$NATIVE[ChainId.ETHEREUM] = Currency.ETHER, _Currency$NATIVE[ChainId.BSC] = Currency.BNB, _Currency$NATIVE[ChainId.BSC_TESTNET] = Currency.BNB, _Currency$NATIVE[ChainId.ROBURNA] = Currency.RBA, _Currency$NATIVE[ChainId.ROBURNA_TESTNET] = Currency.RBA, _Currency$NATIVE);
...
var WETH = (_WETH = {}, _WETH[ChainId.ETHEREUM] = /*#__PURE__*/new Token(ChainId.ETHEREUM, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WETH', 'Wrapped Ether'), _WETH[ChainId.BSC] = /*#__PURE__*/new Token(ChainId.BSC, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WBNB', 'Wrapped BNB'), _WETH[ChainId.BSC_TESTNET] = /*#__PURE__*/new Token(ChainId.BSC_TESTNET, '0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd', 18, 'WBNB', 'Wrapped BNB'), _WETH[ChainId.ROBURNA] = /*#__PURE__*/new Token(ChainId.ROBURNA, '0x86D1D92E543220Bd2F91Ec01694100043a25675A', 18, 'WRBA', 'Wrapped RBA', 'https://www.roburna.com'), _WETH[ChainId.ROBURNA_TESTNET] = /*#__PURE__*/new Token(ChainId.ROBURNA_TESTNET, '0x38aed14869Df0B10abCE55b6de03Ae168b5c1eeF', 18, 'WRBA', 'Wrapped RBA', 'https://www.roburna.com'), _WETH);
...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    var key = composeKey(token0, token1, PairType.INTERNAL);
  ...
  Pair.getAddressEx = function getAddressEx(tokenA, tokenB) {
    ...
    var key = composeKey(token0, token1, PairType.EXTERNAL);

    if (((_PAIR_ADDRESS_CACHE2 = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE2 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE2[key]) === undefined) {
      var _extends3;

      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[key] = getCreate2Address(EXTERNAL_FACTORY_ADDRESS_MAP[token0.chainId], keccak256(['bytes'], [pack(['address', 'address'], [token0.address, token1.address])]), EXTERNAL_CODE_HASH_MAP[token0.chainId]), _extends3));
    }
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    var pairType = trade.route.pairs[0].pairType.toString(); // the router does not support both ether in and out
    ...
    switch (trade.tradeType) {
      case TradeType.EXACT_INPUT:
        if (etherIn) {
          ...
          methodName = 'swapExactTokensForTokens'; // (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
...
var TOKEN_DECIMALS_CACHE = (_TOKEN_DECIMALS_CACHE = {}, _TOKEN_DECIMALS_CACHE[ChainId.ETHEREUM] = {
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, IArborSwapPair, provider).getReserves()).then(function (_ref) {
